        ...
        $payload = [
            ...
            'adults' => [
                ...
                'males' => [
                    ...
                    'disaggregatedByAge' => [
                        '15-19' => $this->copyQuery($eventQuery)->where('birthdate','<=',$parsedReportDate->subYears(15))->where('gender','M')->count(),
                        '20-24' => $this->copyQuery($eventQuery)->whereBetween('birthdate', array($parsedReportDate->subYears(24), $parsedReportDate->subYears(20)))->where('gender','M')->count(),
                        '25-29' => $this->copyQuery($eventQuery)->whereBetween('birthdate', array($parsedReportDate->subYears(29), $parsedReportDate->subYears(25)))->where('gender','M')->count(),
                        '30-34' => $this->copyQuery($eventQuery)->whereBetween('birthdate', array($parsedReportDate->subYears(34), $parsedReportDate->subYears(30)))->where('gender','M')->count(),
                        '35-39' => $this->copyQuery($eventQuery)->whereBetween('birthdate', array($parsedReportDate->subYears(39), $parsedReportDate->subYears(35)))->where('gender','M')->count(),
                        '40-44' => $this->copyQuery($eventQuery)->whereBetween('birthdate', array($parsedReportDate->subYears(44), $parsedReportDate->subYears(40)))->where('gender','M')->count(),
                        '45-49' => $this->copyQuery($eventQuery)->whereBetween('birthdate', array($parsedReportDate->subYears(49), $parsedReportDate->subYears(45)))->where('gender','M')->count(),
